    ...
    namespace schemas {
        ...
        namespace animationsystem_dll {
            ...
            namespace SkeletonAnimCapture_t {
                ...
                constexpr std::ptrdiff_t m_ModelBindPose = 0x30; // CUtlVector<SkeletonAnimCapture_
                constexpr std::ptrdiff_t m_FeModelInitPose = 0x48; // CUtlVector<SkeletonAnimCapture_
            ...
            namespace CRenderGroom {
                ...
                constexpr std::ptrdiff_t m_hairInfoBufferData = 0x18; // 
