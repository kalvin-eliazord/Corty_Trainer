...
namespace GameOffset
{
	namespace Client
	{
		...
		static const intptr_t localPlayer      { modBaseAddr + 0x1730118 };
		static const intptr_t entitiesListBaseAddr{ (modBaseAddr + 0x173DBB8) };
		...
		static int8_t* gameTypeIdPtr{ (int8_t*)(modBaseAddr + 0x1752510) };
	}
